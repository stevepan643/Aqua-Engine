...
public class ShaderProgram {
   ...
   * @since 1.0
   */
  public void addShader(@Nonnull String name, @Nonnull Shader shader) {
  ...
  public void addUniform(@Nonnull Uniform<?> uniform) {
    uniform.setLocation(glGetUniformLocation(shaderProgram, uniform.getName()));
    uniform.update();
  }

  public void addUniforms(@Nonnull Uniform<?>... uniforms) {

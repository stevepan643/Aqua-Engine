...
public class ObjUtil {
    ...
    private static class Face {
        ...
        private IdxGroup parseLine(String line) {
            ...
            if (length > 1) {
                ...
                idxGroup.idxTextCoord = textCoord.length() > 0 ? Integer.parseInt(textCoord) -1 : IdxGroup.NONE;
                if (length > 2) {
    ...
    private static Mesh generateMesh(List<Vector3f> posList, List<Vector2f> textCoordList,
                                     List<Vector3f> normalList, List<Face> faces) {
